...
var _nickbdyer$elm_ttt$Board$markAt = F2(
	function (position, board) {
		return A2(
			...
			'',
			A2(_elm_lang$core$Array$get, position, board));
	});
var _nickbdyer$elm_ttt$Board$mark = F3(
	function (position, symbol, board) {
		return A3(_elm_lang$core$Array$set, position, symbol, board);
	});
var _nickbdyer$elm_ttt$Board$new = function (size) {
	return A2(_elm_lang$core$Array$repeat, size, '');
};

var _nickbdyer$elm_ttt$UI$create2DBoard = function (board) {
...
var _nickbdyer$elm_ttt$UI$showRows = function (board) {
	return A2(
		...
		_nickbdyer$elm_ttt$UI$create2DBoard(board));
};
