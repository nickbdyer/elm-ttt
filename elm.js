...
var _nickbdyer$elm_ttt$Board$new = function (size) {
	return A2(_elm_lang$core$Array$repeat, size, _elm_lang$core$Maybe$Nothing);
};
...
var _nickbdyer$elm_ttt$Game$opponent = function (mark) {
	var _p0 = mark;
	if (_p0.ctor === 'X') {
		return _nickbdyer$elm_ttt$Board$O;
	} else {
		return _nickbdyer$elm_ttt$Board$X;
	}
};
var _nickbdyer$elm_ttt$Game$takeTurn = F2(
...
var _nickbdyer$elm_ttt$Game$new = function (board) {
	return {board: board, currentPlayer: _nickbdyer$elm_ttt$Board$X};
};
var _nickbdyer$elm_ttt$Game$Game = F2(
	function (a, b) {
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['TicTacToe'], 'TicTacToe', typeof _nickbdyer$elm_ttt$TicTacToe$main === 'undefined' ? null : _nickbdyer$elm_ttt$TicTacToe$main);
